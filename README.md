...
I’ve included a minimal CLI for convenience. It accepts an optional path to a CSV file: if none is provided, it defaults to `./websites.csv`, and if `-` is provided, it reads from STDIN.
